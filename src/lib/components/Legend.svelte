...
<div class="mx-auto flex max-w-3xl flex-wrap justify-center gap-x-10 gap-y-4 p-4">
  <button
    type="button"
    class="w-full text-left text-[0.65rem] tracking-wide whitespace-nowrap text-slate-400 uppercase transition-opacity hover:opacity-100"
  ...
  {#if open}
    <div class="flex w-full flex-wrap justify-center gap-x-10 gap-y-4">
      <!-- Cloud Scale -->
